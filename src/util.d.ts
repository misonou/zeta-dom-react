 ...
 */
export function withSuspense<T = any>(factory: () => Promise<{ default: React.ComponentType<T>; }>, fallback?: React.ComponentType | React.ReactElement): React.FC<React.PropsWithChildren<T>>;
